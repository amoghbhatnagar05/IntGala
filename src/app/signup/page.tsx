  ...
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <p className="text-white/50 mb-8">Start cracking jobs for free. No credit card needed.</p>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            >
              <option value="" className="bg-black">Select your target role</option>
              <option value="sde" className="bg-black">Software Developer</option>
              ...
              <option value="fullstack" className="bg-black">Full Stack Developer</option>
              <option value="data" className="bg-black">Data Analyst</option>
              <option value="product" className="bg-black">Product Manager</option>
              <option value="design" className="bg-black">UI/UX Designer</option>
